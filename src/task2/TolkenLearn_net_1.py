...
class EquiUnet(Unet):
    ...
    def __init__(self, inplanes, num_classes, width, norm_layer=None, deep_supervision=False, dropout=0,
        ...
        # self.encoder2_1 = HDC_module1(features[1], features[1], features[1], norm_layer, self.act)
        ...
        # self.encoder3_1 = HDC_module1(features[2], features[2], features[2], norm_layer, self.act)
        ...
        # self.encoder4_1 = HDC_module1(features[3], features[3], features[3], norm_layer, self.act)
