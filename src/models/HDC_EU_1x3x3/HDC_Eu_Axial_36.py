...
from src.models.layers import ConvBnRelu, UBlock, conv1x1, UBlockCbam, CBAM, CBA, UBlock333
from src.models.transformers.position_1 import  AxialBlock
...
class EquiUnet(nn.Module):
    ...
    def __init__(self, inplanes, num_classes, width, norm_layer=None, deep_supervision=False, dropout=0,
        ...
        # decoder stage, we adopt two cov 3x3x3.
        ...
        for m in self.modules():
            ...
            if isinstance(m, nn.Conv3d):
                if isinstance(m, nn.Linear):
                    nn.init.constant_(m.weight, 0.03)
    ...
    def forward(self, x):
        ...
        if self.deep_supervision:
            ...
            deeps.append(output4)
            deeps.append(output3)
            deeps.append(output2)
            deeps.append(output1)
            return out, deeps
        return out
